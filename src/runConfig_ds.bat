...
set AppJars=%AppJars%;%JarDir%\coinor.jar
...
start /min "CalLiteRun%ScenarioName%" C:/CalLite_v3_64bit/jre6/bin/java -Xmx1000m -Xss1280K -Djava.library.path=%PATH% %CLASSPATH% gov.ca.water.calgui.batch.Singleton -config="%ConfigFilePath%"
