...
```{r}
################################################################################################################
runName <- "obs_livneh_wg_template"  # descriptive (unique) name for runs under consistent assumptions and hydrology
...
wytAdap <- F
hydrology <- "obs_livneh_wg_template"
################################################################################################################
...
modelYears <- 63        # number of years for each individual CalLite model
