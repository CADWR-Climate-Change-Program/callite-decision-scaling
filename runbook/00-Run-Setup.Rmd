...
calliteV3 <- "C:\\CalLite_v3"

# Location of monthly 9 addt'l, 11 observed, and 12 rim stations
# simulated by SAC-SMA-DS
simulatedMonthlyDir <- "C:\\Users\\warnold\\California Department of Water Resources\\DWR-EXT-PROJ-SJ Basinwide Study - General\\06_Models\\01_CalLite-WS\\01_DS_CalLiteRunDevelopment\\callite-inputs\\inflow_prep\\climate-change-sim"
...
```{r}
################################################################################################################
runName <- "sjv_base"  # descriptive (unique) name for runs under consistent assumptions and hydrology
...
hydrology <- "sjv_base"
################################################################################################################
ANNset <- "x32"         # "x32" (15 and 45 cm ANNs) or "x64" (15,30,45, and 60cm ANNs)
