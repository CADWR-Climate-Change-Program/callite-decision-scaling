...
climData <- file.path("C:\\Users\\warnold\\California Department of Water Resources\\DWR-EXT-PROJ-SJ Basinwide Study - General\\06_Models\\00_WeatherGenerator\\WG Template Data - Livneh 1950-2013")
...
```{r}
################################################################################################################
runName <- "ref_sjv_ann_input_gen"  # descriptive (unique) name for runs under consistent assumptions and hydrology
...
calLiteRunCount <- 1   # number of individual CalLite model runs per perturbation
modelYears <- 82        # number of years for each individual CalLite model
...
stationsToDatabase(perturbDIR[2:2], con, tChangeList,
